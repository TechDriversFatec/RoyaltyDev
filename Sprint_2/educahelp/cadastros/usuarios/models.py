...
class Usuarios(models.Model):
    ...
    status = models.CharField('staus', max_length=10, default='ATIVO', blank=False, null=False, choices=(
        ('ATIVO', 'ATIVO'),
        ('INATIVO', 'INATIVO'),
        ('EXCLUIDO', 'EXCLUIDO'),
    ))
    observecoes = models.TextField(max_length=200, blank=True, null=True)
    empresa = models.ForeignKey(Empresas, on_delete=models.DO_NOTHING)
